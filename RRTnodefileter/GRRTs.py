...
import time
import os
from RRTnodefileter.Gdrawer import draw_results
from NewRRT.InverseSequence import InverseSquence
from RRTnodefileter.GHalton import GHalton
...
class RRTPlanner():
    ...
    def initialise(self, environment, bounds, start_pose, goal_region, object_radius, steer_distance, num_iterations, resolution, runForFullIterations,rand_fre,num_randpoint,angel,data,node_k):
    ...
    def RRT(self, environment, bounds, start_pose, goal_region, object_radius, steer_distance, num_iterations,
            resolution, drawResults, runForFullIterations,rand_fre,num_randpoint,angel,data,node_k, RRT_Flavour= "RRT"):
        ...
        self.initialise(environment, bounds, start_pose, goal_region, object_radius, steer_distance, num_iterations,
                        resolution, runForFullIterations,rand_fre,num_randpoint,angel,data,node_k)
        ...
        for i in range(self.N):       # N是迭代次数
            ...
            # 通过建立与目标向量之间的角度值选取前四个
                ...
                for thea_tem in thea:
                    ...
                    if self.nodefileter(new_point,nearest_point,self.V)&self.isEdgeCollisionFree(nearest_point, new_point):
