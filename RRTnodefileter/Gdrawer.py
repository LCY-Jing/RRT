...
from RRTnodefileter.Genvironment import plot_environment, plot_line, plot_poly
...
def draw_results(algo_name, path, V, E, env, bounds, object_radius, resolution, start_pose, goal_region, elapsed_time):
    ...
    originalPath,pruningPath,pruningPathAngel,num_i =path
    graph_size = len(V)
